        ...
        <>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Total revenue generated by each team
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                  ...
                  {teamRevenueData.length > 0 ? (
                    teamRevenueData.map((team) => (
                      <TableRow key={team.teamId}>
                        ...
                        <TableCell className="text-right">{team.billableHours}h</TableCell>
                        <TableCell className="text-right font-mono">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cost and revenue breakdown for each team
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                      ...
                      <>
                        ...
                        >
                          ...
                          <TableCell className={cn(
                            ...
                            team.totalProfit >= 0 ? "text-green-600 dark:text-green-500" : "text-red-600 dark:text-red-500"
                          )}>
                        ...
                        {expandedTeams[team.teamId] && team.members.map((member) => (
                          <TableRow key={`${team.teamId}-${member.userId}`} className="bg-muted/40">
                            <TableCell></TableCell>
                            <TableCell className="pl-10">{member.name}</TableCell>
                            <TableCell className="text-right">{member.hoursWorked.toFixed(1)}h</TableCell>
                            <TableCell className="text-right font-mono">
