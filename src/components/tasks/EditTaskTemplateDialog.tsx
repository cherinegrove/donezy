...
import { Plus, Trash2, Link as LinkIcon, ExternalLink, Loader2 } from "lucide-react";
  ...
  const onSubmit = async (data: TaskTemplateFormData) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${data.templateName} has been updated successfully.`,
      });
